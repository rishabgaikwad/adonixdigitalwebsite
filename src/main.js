...
const translations = {
  en: {
    ...
    prod_1_tagline: "\"The definitive hub for all things GPT.\"",
    prod_1_f1: "Centralized directory of AI tools",
    prod_1_f2: "Advanced prompt libraries",
    prod_1_f3: "Daily updates and AI news",
    prod_1_btn: "Explore Platform",
    prod_2_tagline: "\"Your all-in-one social growth engine.\"",
    prod_2_f1: "Automated content scheduling",
    prod_2_f2: "AI-driven audience analytics",
    prod_2_f3: "Multi-platform seamless integration",
    prod_2_btn: "View Social Suite",
    prod_3_tagline: "\"Premium relationship guidance platform.\"",
    prod_3_f1: "Expert relationship insights",
    prod_3_f2: "Modern dating strategies",
    prod_3_f3: "Personalized matchmaking tips",
    prod_3_btn: "Visit datingadvice.io",
    s_1_title: "Personalized AI Voice Assistant",
    s_1_desc: "Tailored voice AI to interact naturally with users.",
    s_2_title: "Custom AI Chat Agent",
    s_2_desc: "Intelligent chat solution for customer support and engagement.",
    s_3_title: "Custom AI Windows Python Web Application",
    s_3_desc: "Bespoke AI-powered desktop/web applications built with Python.",
    s_4_title: "Manage Google & Meta Ads",
    s_4_desc: "Professional management of ad campaigns across Google and Meta platforms.",
    s_5_title: "Affiliate Management System",
    s_5_desc: "Tools to track, manage, and optimize affiliate partnerships.",
    s_6_title: "Custom AI Chat Assistant",
    s_6_desc: "Advanced conversational AI designed for business workflows.",
    s_7_title: "AI Content",
    s_7_desc: "Automated generation of written content for marketing and communication.",
    s_8_title: "Streamlined Workflow Automation",
    s_8_desc: "AI-driven automation to simplify repetitive business processes.",
    s_9_title: "Client Portal",
    s_9_desc: "Secure online portal for clients to access services and information.",
    s_10_title: "AI-Powered Analytics & Reporting Dashboard",
    s_10_desc: "Data insights and reporting powered by artificial intelligence.",
    s_11_title: "Email & SMS Campaigns",
    s_11_desc: "Tools to design and run targeted email and SMS marketing campaigns.",
    s_12_title: "Funnel Builder",
    s_12_desc: "System to create and optimize sales funnels for lead conversion.",
    s_13_title: "Smart Invoicing System",
    s_13_desc: "Automated invoicing solution for efficient billing and payments.",
    s_14_title: "Lead Generation Tools B2B",
    s_14_desc: "AI-driven tools to generate business-to-business leads.",
    s_15_title: "Lead Generation Tools B2C",
    s_15_desc: "AI-driven tools to generate business-to-consumer leads.",
    s_16_title: "Marketing Automations & Engage",
    s_16_desc: "Automated marketing workflows to engage customers effectively.",
    s_17_title: "Membership & Course Area",
    s_17_desc: "Platform for managing memberships and delivering online courses.",
    s_18_title: "Online Booking System",
    s_18_desc: "Integrated system for scheduling and managing appointments.",
    s_19_title: "Request Forms Automation",
    s_19_desc: "Automated handling of customer request forms.",
    s_20_title: "Survey & Form Builder",
    s_20_desc: "Tools to create and manage surveys and forms.",
    s_21_title: "Voice AI Agent",
    s_21_desc: "AI-powered voice agent for customer interaction and support.",
    s_22_title: "Website Builder",
    s_22_desc: "Platform to design and launch websites with AI assistance.",
    s_23_title: "Meta Business Verification",
    s_23_desc: "Service to verify and secure Meta business accounts.",
    s_24_title: "WhatsApp Integration",
  ...
  ar: {
    ...
    products_subtitle: "استكشف منتجاتنا الرائدة ومشاريعنا الناجحة التي تعيد تعريف المشهد الرقمي.",
    prod_1_tagline: "\"المركز الشامل لكل ما يخص GPT.\"",
    prod_1_f1: "دليل مركزي لأدوات الذكاء الاصطناعي",
    prod_1_f2: "مكتبات تلقين متقدمة",
    prod_1_f3: "تحديثات يومية وأخبار الذكاء الاصطناعي",
    prod_1_btn: "استكشف المنصة",
    prod_2_tagline: "\"محرك نمو اجتماعي متكامل.\"",
    prod_2_f1: "جدولة المحتوى التلقائية",
    prod_2_f2: "تحليلات الجمهور بالذكاء الاصطناعي",
    prod_2_f3: "تكامل سلس عبر منصات متعددة",
    prod_2_btn: "عرض Social Suite",
    prod_3_tagline: "\"منصة توجيه علاقات متميزة.\"",
    prod_3_f1: "رؤى خبراء في العلاقات",
    prod_3_f2: "استراتيجيات تعارف حديثة",
    prod_3_f3: "نصائح توفيق مخصصة",
    prod_3_btn: "زيارة datingadvice.io",
    s_1_title: "مساعد صوتي شخصي بالذكاء الاصطناعي",
    s_1_desc: "ذكاء اصطناعي صوتي مخصص للتفاعل بانسجام مع المستخدمين.",
    s_2_title: "وكيل دردشة مخصص بالذكاء الاصطناعي",
    s_2_desc: "حل دردشة ذكي لدعم العملاء وتعزيز التفاعل.",
    s_3_title: "تطبيقات ويب وويندوز مخصصة ببايثون",
    s_3_desc: "تطبيقات ويب ومكتبية مخصصة مدعومة بالذكاء الاصطناعي ومبنية بلغة بايثون.",
    s_4_title: "إدارة إعلانات جوجل وميتا",
    s_4_desc: "إدارة احترافية للحملات الإعلانية عبر منصات جوجل وميتا.",
    s_5_title: "نظام إدارة التسويق بالعمولة",
    s_5_desc: "أدوات لتتبع وإدارة وتحسين شراكات التسويق بالعمولة.",
    s_6_title: "مساعد دردشة مخصص بالذكاء الاصطناعي",
    s_6_desc: "ذكاء اصطناعي حواري متقدم مصمم لسير عمل الشركات.",
    s_7_title: "محتوى مدعوم بالذكاء الاصطناعي",
    s_7_desc: "توليد آلي للمحتوى المكتوب للتسويق والتواصل.",
    s_8_title: "أتمتة سير العمل بفعالية",
    s_8_desc: "أتمتة مدعومة بالذكاء الاصطناعي لتبسيط العمليات التجارية المتكررة.",
    s_9_title: "بوابة العملاء",
    s_9_desc: "بوابة إلكترونية آمنة للعملاء للوصول إلى الخدمات والمعلومات.",
    s_10_title: "لوحة تحكم وتقارير مدعومة بالذكاء الاصطناعي",
    s_10_desc: "رؤى للبيانات وتقارير مدعومة بالذكاء الاصطناعي.",
    s_11_title: "حملات البريد الإلكتروني والرسائل النصية",
    s_11_desc: "أدوات لتصميم وإدارة حملات تسويقية مستهدفة عبر البريد والرسائل.",
    s_12_title: "أداة بناء مسارات المبيعات",
    s_12_desc: "نظام لإنشاء وتحسين مسارات المبيعات لتحويل العملاء المحتملين.",
    s_13_title: "نظام الفوترة الذكي",
    s_13_desc: "حل أتمتة الفواتير لعمليات دفع وفوترة فعالة.",
    s_14_title: "أدوات توليد العملاء المحتملين للشركات",
    s_14_desc: "أدوات ذكية لتوليد عملاء محتملين في قطاع الأعمال.",
    s_15_title: "أدوات توليد العملاء المحتملين للأفراد",
    s_15_desc: "أدوات ذكية لتوليد عملاء محتملين في قطاع الأفراد.",
    s_16_title: "أتمتة التسويق والتفاعل",
    s_16_desc: "مسارات تسويقية مؤتمتة لإشراك العملاء بشكل فعال.",
    s_17_title: "منصة العضويات والدورات",
    s_17_desc: "منصة متكاملة لإدارة العضويات وتقديم الدورات الإلكترونية.",
    s_18_title: "نظام الحجز الإلكتروني",
    s_18_desc: "نظام متكامل لجدولة وإدارة المواعيد.",
    s_19_title: "أتمتة نماذج الطلبات",
    s_19_desc: "معالجة آلية لنماذج طلبات العملاء.",
    s_20_title: "أداة بناء الاستبيانات والنماذج",
    s_20_desc: "أدوات لإنشاء وإدارة الاستبيانات والنماذج.",
    s_21_title: "وكيل صوتي بالذكاء الاصطناعي",
    s_21_desc: "وكيل صوتي ذكي لتفاعل ودعم العملاء.",
    s_22_title: "أداة بناء المواقع",
    s_22_desc: "منصة لتصميم وإطلاق المواقع بمساعدة الذكاء الاصطناعي.",
    s_23_title: "توثيق حسابات ميتا للأعمال",
    s_23_desc: "خدمة لتوثيق وتأمين حسابات الأعمال على ميتا.",
    s_24_title: "تكامل واتساب للأعمال",
